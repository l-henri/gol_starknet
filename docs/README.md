...
| **v3 (next)** | [v3-identity-spec.md](v3-identity-spec.md) | The orbit-canonical identity model: one id system, copies prevented at mint |
| **Product ideas** | [leaderboards.md](leaderboards.md), [audience-research.md](audience-research.md), [pet-mechanism-spec.md](pet-mechanism-spec.md) | Browse the leaderboard catalogue, the audience/distribution research, and the pet-bond spec |
