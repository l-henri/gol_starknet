...
| **v3 (live)** | [v3-identity-spec.md](v3-identity-spec.md), [mainnet-deployment.md](mainnet-deployment.md), [v3-deployment.md](v3-deployment.md) | The orbit-canonical identity model: one id system, copies prevented at mint — LIVE ON MAINNET (2026-07-31); the Sepolia deployment is the 2026-07-06 predecessor |
