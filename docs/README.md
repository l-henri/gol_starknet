...
| **v2 & mechanisms** | [v2-grid-redesign.md](v2-grid-redesign.md), [v2-deployment.md](v2-deployment.md), [path-creatures-spec.md](path-creatures-spec.md), [symmetry-challenge-spec.md](symmetry-challenge-spec.md), [partial-paths-mint-ux.md](partial-paths-mint-ux.md), [sierra-gas-metering-discrepancy.md](sierra-gas-metering-discrepancy.md), [gas-optimization-research.md](gas-optimization-research.md) | Understand the 41×41 v2 system, its deployments, burn mechanisms, and gas realities |
| **v3 (live)** | [v3-identity-spec.md](v3-identity-spec.md), [mainnet-deployment.md](mainnet-deployment.md), [v3-deployment.md](v3-deployment.md), [migration-runbook.md](migration-runbook.md) | The orbit-canonical identity model: one id system, copies prevented at mint — LIVE ON MAINNET (2026-07-31); the Sepolia deployment is the 2026-07-06 predecessor |
...
| **Frontend** | [frontend.md](frontend.md), [privy-email-login.md](privy-email-login.md) | Understand or extend the Next.js web app and its Starknet integration; the email-login door (Privy + AVNU paymaster, sponsored gas) |
