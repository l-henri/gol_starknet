...
**Live site:** https://gol-starknet.vercel.app — production tracks `main` (currently SEPOLIA per the 2026-07-31 walk-back); THIS branch (`mainnet`) carries the flip and goes live when merged into `main`. Vercel builds it as a preview on every push.
