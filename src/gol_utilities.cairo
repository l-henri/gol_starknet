...
pub mod GolUtilitiesComponent {
    ...
    > of super::IGolUtilities<ComponentState<TContractState>>  {
        ...
        fn detect_loop(self: @ComponentState<TContractState>, sequence_of_states: Array<felt252>) -> Array<felt252> {
        ...
        fn validate_loop_from_array(self: @ComponentState<TContractState>, sequence: Array<felt252>) -> bool {
            if sequence.len() < 1 {
                return false;
            }
        ...
        fn validate_loop_from_initial_state(self: @ComponentState<TContractState>, initial_state: felt252, generations: usize) -> bool {
